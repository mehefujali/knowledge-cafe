...
const Blog = ({ blog, handelSetReadingTime, handelSetBookmark }) => {
      ...
      return (
            <div className=' w-full h-full flex flex-col gap-1 '>
                  ...
                  <button onClick={() => handelSetReadingTime(parseFloat(readingTime))} className=' btn btn-sm w-fit bg-transparent border-violet-500 text-violet-500 hover:border-none hover:bg-violet-500 hover:text-white'>Mark as read</button>
            </div>
      );
};
